 ...
 * OpenAI-family protocol: the literal `[DONE]` is yielded so the caller owns
 * final flushing, and EOF before it raises `LlmError` (`STREAM_CLOSED`).
 *
 * Port of `packages/llm/llm-codebuddy/src/sse.ts`.
 * @module dsh-codebuddy-code/sse
 */

import { EventSourceParserStream } from 'eventsource-parser/stream'
import { LlmError } from '@deepseek-ai/dsh-llm'

/** The terminal payload CodeBuddy (and OpenAI) send after the last chunk. */
